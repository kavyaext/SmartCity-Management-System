...
public class Hospital extends javax.swing.JFrame {
    ...
    public Hospital(String datapass, String area) {
        initComponents();
   ...
   /*
    alter Transport rename column Tables_no to Seats_no;
...
Query OK, 0 rows affected (0.00 sec)
  insert into Hospital value("GH HOSPITAL","123, ABC, CS Street","9876543210",100,"College street");

Query OK, 1 row affected (0.00 sec)

mysql> insert into Hospital value("ST HOSPITAL","98, XYZ, Church View","9876541234",100,"Church View");
Query OK, 1 row affected (0.00 sec)
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel5.setText("No. of beds available");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try(Connection conn = DriverManager.getConnection(url,user,password);
         Statement stmt = conn.createStatement();
           ...
           sql="update Hospital set Beds_count="+(nob-1)+" where area='"+area+"';";
           int N = stmt.executeUpdate(sql);
           jTextField3.setText((nob-1)+"");
