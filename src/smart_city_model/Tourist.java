...
public class Tourist extends javax.swing.JFrame {
    ...
    public Tourist(String datapass, String area) {
        initComponents();
        this.datapass = datapass;
        this.area = area;
        getTouristsDetails();
    }
   void getTouristsDetails(){
       ...
       try(Connection conn = DriverManager.getConnection(url,user,password);
         Statement stmt = conn.createStatement();
           ...
           ResultSet rs;
           sql="select * from Tourist where Area = '"+area+"';";
           rs=stmt.executeQuery(sql);
           while(rs.next()){
               name = rs.getString("Name");
               add = rs.getString("Address");
               phno = rs.getString("Contact_no");
               nosp = rs.getInt("Ticket_count");
           }
           jTextField1.setText(name);
           jTextArea1.setText(add);
           jTextField2.setText(phno);
           jTextField3.setText(nosp+"");
           }catch (Exception x) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tourist Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try(Connection conn = DriverManager.getConnection(url,user,password);
            ...
            sql="update Tourist set Ticket_count="+(nosp-1)+" where area='"+area+"';";
            int N = stmt.executeUpdate(sql);
            jTextField3.setText((nosp-1)+"");
