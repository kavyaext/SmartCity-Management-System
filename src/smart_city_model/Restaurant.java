...
public class Restaurant extends javax.swing.JFrame {
    ...
    public Restaurant(String datapass, String area) {
        initComponents();
...
void getRestaurantDetails(){
       ...
       try(Connection conn = DriverManager.getConnection(url,user,password);
         Statement stmt = conn.createStatement();
           ...
           while(rs.next()){
               ...
               nots = rs.getInt("Tables_count");
           }
           jTextField1.setText(name);
           jTextArea1.setText(add);
           jTextField2.setText(phno);
           jTextField3.setText(nots+"");
           }catch (Exception x) {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("No. of tables available");
        ...
        jButton1.setText("Book New Table");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try(Connection conn = DriverManager.getConnection(url,user,password);
            ...
            sql="update Restaurant set Tables_count="+(nots-1)+" where area='"+area+"';";
            int N = stmt.executeUpdate(sql);
            jTextField3.setText((nots-1)+"");
