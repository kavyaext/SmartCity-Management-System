...
public class Electricity extends javax.swing.JFrame {
   ...
   static String datapass, area;
    public Electricity(String datapass, String area) {
        initComponents();
         this.datapass = datapass;
        this.area = area;
        getElectricityDetails();
    }
void getElectricityDetails(){
       ...
       try(Connection conn = DriverManager.getConnection(url,user,password);
         Statement stmt = conn.createStatement();
           ...
           ResultSet rs;
           sql="select * from electricityres  where Area = '"+area+"';";
           rs=stmt.executeQuery(sql);
           while(rs.next()){
               name = rs.getString("Name");
               add = rs.getString("Address");
               phno = rs.getString("Contact_no");
               noel = rs.getInt("elec_count");
           }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Electricity Board Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try(Connection conn = DriverManager.getConnection(url,user,password);
            ...
            sql="update electricityres set elec_count="+(noel-1)+" where area='"+area+"';";
